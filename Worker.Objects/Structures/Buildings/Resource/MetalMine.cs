...
namespace Worker.Objects.Structures.Buildings.Resource
{
    ...
    {
        public MetalMine(Planet belongsTo, int currentLevel, bool techReached, bool canBuild) : base(belongsTo,
            currentLevel, techReached, canBuild)
        {
        }

        public override BuildingType Type => BuildingType.MetalMine;
